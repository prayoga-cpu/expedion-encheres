                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'q064d1gc' /* Nous serions ravis d'avoir de ... */,
                        ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'p61wm31g' /* Envoyez-nous un courriel */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .titleMedium
                                      .override(
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    '8gz1mb9f' /* Contact@expedion-encheres.com */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'drm01ryv' /* Envoyez-nous un message */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: TextFormField(
                                    controller: _model.sujetTextController,
